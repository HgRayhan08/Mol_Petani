...
class TableAcceptedKuota extends ConsumerStatefulWidget {
  final double width;
  final double height;
  final WidgetRef ref;
  const TableAcceptedKuota({
    super.key,
    required this.ref,
    required this.width,
  ...
  @override
  ConsumerState<TableAcceptedKuota> createState() => _TableAcceptedKuotaState();
}

class _TableAcceptedKuotaState extends ConsumerState<TableAcceptedKuota> {
