...
class TableMember extends ConsumerStatefulWidget {
  final double width;
  final double height;
  final WidgetRef ref;
  const TableMember({
  ...
  @override
  ConsumerState<TableMember> createState() => _TableMemberState();
}

class _TableMemberState extends ConsumerState<TableMember> {
                ...
                context.buildShowDialog(
                  ...
                  onTapSucces: () async {
                    ...
                    await ref
                        ...
                        .deleteMemberFarmerGroup(idDocument: data.idDocument!);
                  },
                  judul: "Konfirmasi Hapus Member",
                  keterangan: "Apakah Anda yakin ingin menghapus Memmber?",
                );
              },
            ),
          ],
