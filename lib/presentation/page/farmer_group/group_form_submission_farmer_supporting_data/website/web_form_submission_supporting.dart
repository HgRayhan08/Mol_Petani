...
class WebFormSubmisionSupporting extends StatefulWidget {
  final WidgetRef ref;
  ...
  @override
  State<WebFormSubmisionSupporting> createState() =>
      _WebFormSubmisionSupportingState();
}

class _WebFormSubmisionSupportingState
    extends State<WebFormSubmisionSupporting> {
  @override
            ...
            if (widget.namaPetaniControler.text == "" ||
              ...
              Future.delayed(
                ...
                () {
                  widget.ref
                      .read(routerProvider)
                      .goNamed("detail-submission-grup");
                },
              );
            }
          },
