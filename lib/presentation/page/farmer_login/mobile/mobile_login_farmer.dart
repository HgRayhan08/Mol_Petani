...
import 'package:mol_petani/presentation/page/farmer_login/method/form_login_farmer.dart';
import 'package:mol_petani/presentation/page/farmer_login/method/opener_petani.dart';
import 'package:mol_petani/presentation/provider/user_data/data_user_provider.dart';

class MobileLoginFarmer extends ConsumerWidget {
          ...
          switch (ref.watch(dataUserProvider)) {
            AsyncData(:final value) => value == null
                ? ElevatedButton(
                    ...
                    onPressed: () {
                      ref.read(dataUserProvider.notifier).loginFarmer(
