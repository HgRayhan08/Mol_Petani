...
class WebFormSend extends StatefulWidget {
  final WidgetRef ref;
  ...
  @override
  State<WebFormSend> createState() => _WebFormSendState();
}

class _WebFormSendState extends State<WebFormSend> {
  @override
  ...
  void _submission() async {
    if (widget.nameControler.text != "" ||
      ...
      context.buildAlertInformation(
          title: "Pesan", subTitle: "Tolong lengkapi data Dengan Benar");
    }
  }
}
