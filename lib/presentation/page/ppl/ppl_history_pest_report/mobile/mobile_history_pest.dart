...
class MobileHistoryPest extends StatelessWidget {
  final WidgetRef ref;
  const MobileHistoryPest({super.key, required this.ref});
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: ref.watch(reportProviderProvider.notifier).getHistoryPestReport(),
            ...
            itemBuilder: (context, index) {
              return ListTileReportingWidget(
                ...
                onTap: () {
                  ref
                      .read(routerProvider)
                      .goNamed("ppl-detail-pest-reporting", extra: data[index]);
                },
              );
            },
          );
