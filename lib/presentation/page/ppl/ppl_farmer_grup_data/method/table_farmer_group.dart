...
class TableFarmerGroup extends ConsumerStatefulWidget {
  final double width;
  final double height;
  final WidgetRef ref;
  const TableFarmerGroup({
    super.key,
    required this.ref,
    required this.width,
  ...
  @override
  ConsumerState<TableFarmerGroup> createState() => _TableFarmerGroupState();
}

class _TableFarmerGroupState extends ConsumerState<TableFarmerGroup> {
                ...
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return Dialog(
                      ...
                      child: PplDetailFarmerGroupPage(data),
                    );
                  },
                );
              },
                ...
                context.buildShowDialog(
                  ...
                  onTapSucces: () async {
                    ...
                    ref
                        ...
                        .deleteFarmerGroup(idDocument: data.uid);
