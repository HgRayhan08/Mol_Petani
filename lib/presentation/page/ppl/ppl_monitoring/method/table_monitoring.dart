...
class TableMonitoring extends ConsumerStatefulWidget {
  final double width;
  final double height;
  final WidgetRef ref;
  ...
  @override
  ConsumerState<TableMonitoring> createState() => _TableMonitoringState();
}

class _TableMonitoringState extends ConsumerState<TableMonitoring> {
          ...
          children: [
            IconButton(
              ...
              onPressed: () async {
                ref
                    .read(routerProvider)
                    .goNamed('monitoring-group', extra: data);
              },
            ),
          ],
        );
          ...
          rows = data.asMap().entries.map<PlutoRow>((e) {
            return PlutoRow(
              cells: {
                ...
                'kelompok': PlutoCell(value: e.value.farmerGrup),
