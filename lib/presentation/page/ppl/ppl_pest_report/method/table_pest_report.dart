...
class TablePestReport extends ConsumerStatefulWidget {
  final double width;
  final double height;
  final WidgetRef ref;
  const TablePestReport({
    super.key,
    required this.ref,
    required this.width,
  ...
  @override
  ConsumerState<TablePestReport> createState() => _TablePestReportState();
}

class _TablePestReportState extends ConsumerState<TablePestReport> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: widget.ref.watch(reportProviderProvider.notifier).getReportHama(),
