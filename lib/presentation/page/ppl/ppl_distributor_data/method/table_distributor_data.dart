...
class TableDistributionData extends ConsumerStatefulWidget {
  final double width;
  final double height;
  final WidgetRef ref;
  ...
  @override
  ConsumerState<TableDistributionData> createState() =>
      _TableDistributionDataState();
}

class _TableDistributionDataState extends ConsumerState<TableDistributionData> {
  ...
  Widget _buildRowAction(PlutoColumnRendererContext rendererContext) {
    return Consumer(
      builder: (context, ref, child) {
        final data = rendererContext.cell.value as UserDistrubutor;
        return Row(
          children: [
            IconButton(
                ...
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return Dialog(
                      ...
                      child: PplDetailDistributorPage(data),
                    );
                  },
                );
              },
                ...
                context.buildShowDialog(
                  ...
                  onTapSucces: () async {
                    ...
                    ref
                        ...
                        .deleteDistributor(idDocument: data.uid);
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: widget.ref.watch(dataUserProvider.notifier).getallDistributor(),
