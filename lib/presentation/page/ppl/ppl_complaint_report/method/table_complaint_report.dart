...
class TableComplaintReport extends ConsumerStatefulWidget {
  final double width;
  final double height;
  final WidgetRef ref;
  const TableComplaintReport({
    super.key,
    required this.ref,
    required this.width,
  ...
  @override
  ConsumerState<TableComplaintReport> createState() =>
      _TableComplaintReportState();
}

class _TableComplaintReportState extends ConsumerState<TableComplaintReport> {
