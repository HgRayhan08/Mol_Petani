...
class PplMonitoringSubmissionGroupFarmer extends ConsumerWidget {
  final SubmissionKuotaFertilizer data;
  const PplMonitoringSubmissionGroupFarmer(this.data, {super.key});
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(data.senderName, style: largeReguler),
                SizedBox(height: height * 0.02),
                Text(
                  "Penerima",
                  style: regulerReguler.copyWith(fontWeight: FontWeight.bold),
                ),
                Text(data.recipientNameSender, style: largeReguler),
                SizedBox(height: height * 0.02),
                Text(
                  "Tanggal Pelaksana",
                  style: regulerReguler.copyWith(fontWeight: FontWeight.bold),
                ),
                Text(data.reciptDate, style: largeReguler)
              ],
            ),
          )
        ],
